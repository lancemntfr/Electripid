...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['register'])) {
    ...
    if (empty($fname) || empty($lname) || empty($email) || empty($password) || empty($confirm_password)) {
        ...
        if ($check_result && mysqli_num_rows($check_result) > 0) {
            ...
            $insert_user_query = "
                INSERT INTO USER (fname, lname, email, cp_number, city, barangay, password, role, acc_status)
                VALUES ('$fname', '$lname', '$email', '$cp_number', '$city', '$barangay', '$hashed_password', 'user', 'inactive')
            ";
            ...
            if ($user_result) {
                ...
                // Create household
                $insert_household_query = "
                    INSERT INTO HOUSEHOLD (user_id, provider_id)
                ...
                $verification_query = "
                    ...
                    VALUES ('$user_id', 'email', '$verification_code', '$expires_at')
                ";
                executeQuery($verification_query);

                // Send verification email
                $verify_link = "http://192.168.18.153/electripid/user/verify_email.php?code=$verification_code";
                ...
                try {
                    ...
                    $mail->SMTPAuth = true;
                    $mail->Username = 'electripid.official2026@gmail.com';
                    $mail->Password = 'wgauukbqsdubumlh';
                    $mail->SMTPSecure = 'tls';
                    $mail->Port = 587;

                    $mail->setFrom('electripid.official2026@gmail.com', 'Electripid');
...
<body>
    <div class="auth-container">
        ...
        <!-- Right Section - Welcome (Blue Background) -->
